...
### Problem 1: Unreachable INVALID\_\* Codes (40 codes)
...
### Phase 1: Remove Unreachable INVALID\_\* Codes (40 codes → 0)
...
- 2000-2029: INVALID\_\* expression validation codes (30 codes)
- 2100-2106: INVALID\_\* statement validation codes (7 codes)
- 2113-2116: INVALID\_\* operator/number codes (4 codes)
...
| ----------------------------- | ------- | ----------- | ---------------- |
| Unreachable INVALID\_\* codes | 40      | 0           | -40              |
...
2. Remove unreachable INVALID\_\* checks
