...
type TContainedBy = ParseSqlStatement<
	...
	DbArrays
>
type _tContainedBy = Expect<Extends<Tuple3At2<TContainedBy>, { kind: "select"; columns: { contained: TBoolean } }>>

// Test @> (contains) operator
type TContains = ParseSqlStatement<ParseSqlTokens<`select tags @> array['a'] as contains from items;`>, DbArrays>
type _tContains = Expect<Extends<Tuple3At2<TContains>, { kind: "select"; columns: { contains: TBoolean } }>>
...
type _tOverlaps = Expect<Extends<Tuple3At2<TOverlaps>, { kind: "select"; columns: { overlaps: TBoolean } }>>
...
type _tEquals = Expect<Extends<Tuple3At2<TEquals>, { kind: "select"; columns: { equals: TBoolean } }>>
...
type _tConcat = Expect<Extends<Tuple3At2<TConcat>, { kind: "select"; columns: { concatenated: TTextArray } }>>
...
type _tConcatColumn = Expect<Extends<Tuple3At2<TConcatColumn>, { kind: "select"; columns: { doubled: TTextArray } }>>
...
type _tIntArrayOps = Expect<
	Extends<Tuple3At2<TIntArrayOps>, { kind: "select"; columns: { has_nums: TBoolean; exact: TBoolean } }>
>
