...
const UNTESTABLE_ERROR_CODES = new Set([
	...
	// Parser error recovery - INSERT (9 codes)
	...
	// Consolidated codes used in tests (2 codes)
	...
	// Parser error recovery - UPDATE (3 codes)
	...
	// Parser error recovery - DDL (9 codes)
	...
	3905, // EXPECTED_SEMICOLON_AFTER_CREATE_VIEW - SELECT parser consumes trailing tokens (now consolidated to 1105)
	...
	// Additional unreachable or very difficult to test codes (20 codes)
	...
	4104, // OBSOLETE_4104_EXPECTED_TYPE_NAME_GENERIC - Consolidated to 4105
	...
	// Final 10 codes that are difficult to test or require complex implementation
	1700, // OBSOLETE_1700_EXPECTED_SEMICOLON_AFTER_DROP_TABLE - Consolidated to 1105
	...
	// Phase 2a: OBSOLETE codes - UNKNOWN_* family consolidated
	2201, // OBSOLETE_2201_UNKNOWN_TABLE_UPDATE - Use 2200 UNKNOWN_TABLE
	2203, // OBSOLETE_2203_UNKNOWN_TABLE_INSERT_INTO - Use 2200 UNKNOWN_TABLE
	2204, // OBSOLETE_2204_UNKNOWN_TABLE_DELETE_FROM - Use 2200 UNKNOWN_TABLE
	2205, // OBSOLETE_2205_UNKNOWN_TABLE_IN_DELETE_USING - Use 2200 UNKNOWN_TABLE
	2208, // OBSOLETE_2208_UNKNOWN_SCHEMA_OR_TABLE_IN_FROM - Use 2207 UNKNOWN_SCHEMA_OR_TABLE
	2209, // OBSOLETE_2209_UNKNOWN_SCHEMA_OR_TABLE_IN_UPDATE - Use 2207 UNKNOWN_SCHEMA_OR_TABLE
	2211, // OBSOLETE_2211_UNKNOWN_SCHEMA_OR_TABLE_IN_INSERT_INTO - Use 2207 UNKNOWN_SCHEMA_OR_TABLE
	2212, // OBSOLETE_2212_UNKNOWN_SCHEMA_OR_TABLE_IN_DELETE_FROM - Use 2207 UNKNOWN_SCHEMA_OR_TABLE
	2213, // OBSOLETE_2213_UNKNOWN_SCHEMA_OR_TABLE_IN_DELETE_USING - Use 2207 UNKNOWN_SCHEMA_OR_TABLE
	2215, // OBSOLETE_2215_UNKNOWN_SCHEMA_FOR_CREATE_TYPE - Use 2214 UNKNOWN_SCHEMA
	2216, // OBSOLETE_2216_UNKNOWN_SCHEMA_FOR_CREATE_VIEW - Use 2214 UNKNOWN_SCHEMA
	2301, // OBSOLETE_2301_UNKNOWN_COLUMN_UPDATE_SET - Use 2300 UNKNOWN_COLUMN
	2303, // OBSOLETE_2303_UNKNOWN_COLUMN_IN_INSERT_COLUMN_LIST - Use 2300 UNKNOWN_COLUMN
	2304, // OBSOLETE_2304_UNKNOWN_COLUMN_IN_ON_CONFLICT - Use 2300 UNKNOWN_COLUMN
	2305, // OBSOLETE_2305_UNKNOWN_COLUMN_IN_ON_CONFLICT_DO_UPDATE_SET - Use 2300 UNKNOWN_COLUMN

	// Phase 2b: OBSOLETE codes - EXPECTED_* family consolidated
	// Group 1: EXPECTED_SEMICOLON_AFTER_* (13 codes) - Use 1105 EXPECTED_SEMICOLON
	...
	// Group 2: EXPECTED_TABLE_NAME_* (13 codes) - Use 1120 EXPECTED_TABLE_NAME
	1121, // OBSOLETE_1121_EXPECTED_TABLE_NAME_OR_OPEN_PAREN_IN_FROM (kept as specific)
	...
	// Group 3: EXPECTED_COLUMN_NAME_* (7 codes) - Use 1206 EXPECTED_COLUMN_NAME
	...
	// Group 4: EXPECTED_TYPE_NAME_* (5 codes) - Use 4105 EXPECTED_TYPE_NAME
	...
	// Group 5: JOIN-related EXPECTED_* (8 codes) - Use 4200 EXPECTED_JOIN_KEYWORD
