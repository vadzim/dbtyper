// Integration Test: ALTER TYPE - Missing ADD keyword
...
// ❌ ERROR: Missing ADD keyword in ALTER TYPE (when followed by semicolon)
const query = `alter type status;` as const
...
type _errorCheck = Expect<
	Extends<ExtractQueryError<DbShape, typeof query>, DbtyperError<4001, "Expected `.` or `ADD` in ALTER TYPE">>
>
