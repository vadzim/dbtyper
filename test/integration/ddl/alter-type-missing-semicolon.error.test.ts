// Integration Test: ALTER TYPE - Missing semicolon
...
// ❌ ERROR: Missing semicolon after ALTER TYPE
const query = `alter type status add value 'inactive' trailing` as const
...
type _errorCheck = Expect<
	Extends<ExtractQueryError<DbShape, typeof query>, DbtyperError<1105, "Expected semicolon after ALTER TYPE">>
>
