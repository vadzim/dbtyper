// Integration Test: CREATE TYPE - Missing open paren before enum values
...
// ❌ ERROR: Missing open paren before enum values
...
type _errorCheck = Expect<
	Extends<ExtractQueryError<DbShape, typeof query>, DbtyperError<1805, "Expected `(` before enum values in CREATE TYPE">>
>
