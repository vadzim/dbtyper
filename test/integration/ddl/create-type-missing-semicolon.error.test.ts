// Integration Test: CREATE TYPE - Missing semicolon
...
// ❌ ERROR: Missing semicolon after CREATE TYPE
const query = `create type status as enum ('active', 'inactive') trailing` as const
