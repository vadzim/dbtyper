...
// ❌ ERROR: DROP SCHEMA missing name
const query = `drop schema ;` as const
...
type _errorCheck = Expect<
	Matches<ExtractQueryError<DbShape, typeof query>, DbtyperError<3800, "Expected schema name in DROP SCHEMA">>
>
