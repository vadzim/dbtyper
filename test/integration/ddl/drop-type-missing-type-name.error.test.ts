// Integration Test: DROP TYPE - Missing type name
...
// ❌ ERROR: Missing type name in DROP TYPE
const query = `drop type;` as const
...
type _errorCheck = Expect<
	Extends<ExtractQueryError<DbShape, typeof query>, DbtyperError<4105, "Expected type name in DROP TYPE">>
>
