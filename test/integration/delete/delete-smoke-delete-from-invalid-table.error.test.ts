...
const query = `delete from invalid_table;` as const
...
type _errorCheck = Expect<
	Matches<ExtractQueryError<DbShape, typeof query>, DbtyperError<2200, "Unknown table invalid_table in DELETE FROM">>
>
