// Integration Test: DELETE - unknown schema or table in USING
...
// ❌ ERROR: Unknown schema or table in DELETE USING
const query = `delete from users using ghost_schema.other;` as const
...
type _errorCheck = Expect<
	Matches<
		...
		DbtyperError<2207, "Unknown schema or table ghost_schema in DELETE USING">
	>
>
