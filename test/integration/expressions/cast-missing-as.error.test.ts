// Integration Test: CAST Expression Syntax
...
const query = `select cast('text' integer) as x from users;` as const
...
type _errorCheck = Expect<Matches<ExtractQueryError<DbShape, typeof query>, DbtyperError<4502, "Expected AS in CAST">>>
