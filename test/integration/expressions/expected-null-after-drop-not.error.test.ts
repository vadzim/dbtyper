// Integration Test: Expected NULL after DROP NOT (5004)
...
const query = `alter table items alter column id drop not invalid;` as const
...
type _errorCheck = Expect<
	Matches<ExtractQueryError<DbShape, typeof query>, DbtyperError<5004, "Expected NULL after DROP NOT">>
>
