...
// ❌ ERROR: Incompatible types in CASE
const query = `select case when true then 'text' when false then 42 end as x;` as const
...
type _errorCheck = Expect<
	Matches<ExtractQueryError<DbShape, typeof query>, DbtyperError<2502, "Incompatible types in CASE">>
>
