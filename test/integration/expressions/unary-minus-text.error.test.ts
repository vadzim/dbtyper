...
// ❌ ERROR: Unary minus on text column
const query = `select -(users.name) as x from users;` as const
...
type _errorCheck = Expect<
	Matches<ExtractQueryError<DbShape, typeof query>, DbtyperError<2800, "Unary minus requires a number">>
>
