...
// ❌ ERROR: Unknown query parameter in WHERE clause
const query = `select users.id from users where :unknown = 'x';` as const
...
type _errorCheck = Expect<
	Matches<ExtractQueryError<DbShape, typeof query>, DbtyperError<2400, "Unknown query parameter: unknown">>
>
