...
// ❌ ERROR: INSERT column list must not be empty
const query = `insert into users () values ();` as const
...
type _errorCheck = Expect<
	Matches<ExtractQueryError<DbShape, typeof query>, DbtyperError<3301, "INSERT column list must not be empty">>
>
