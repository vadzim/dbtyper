...
// ❌ ERROR: Ambiguous unqualified column in JOIN
const query = `select id from users join billing.subs as billing_sub on users.id = billing_sub.user_id;` as const
...
type _errorCheck = Expect<
	Matches<ExtractQueryError<DbShape, typeof query>, DbtyperError<3404, "Ambiguous unqualified column id">>
>
