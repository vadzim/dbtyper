// Integration Test: SELECT with ANY/ALL/SOME operators - = SOME with array (alias for ANY)
...
const _result = await _db.query(`select * from items where id = some(array[5,6,7]);`)
