// Integration Test: SELECT with ANY/ALL/SOME operators - SOME with subquery
...
const _result = await _db.query(`select * from items where priority = some(select value from priorities);`)
