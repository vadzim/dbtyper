// Integration Test: SELECT with array operators - && (overlaps) operator - already working
...
const _result = await _db.query(`select tags && array['a','b'] as overlaps from items;`)
