...
// ❌ column(integer) || column(integer) → error
const query = `select age || age as invalid from users;` as const
...
type _errorCheck = Expect<
	Matches<ExtractQueryError<DbShape, typeof query>, DbtyperError<2800, "|| requires at least one text operand">>
>
