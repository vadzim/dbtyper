// Integration Test: SELECT with FULL OUTER JOIN - FULL JOIN (without OUTER keyword)
...
const _result = await _db.query(`select * from users full join orders on users.id = orders.user_id;`)
