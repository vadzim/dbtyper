// Integration Test: JOIN syntax error - missing JOIN after RIGHT OUTER
...
// ❌ ERROR: missing JOIN after RIGHT OUTER
const query = `select * from users right outer posts on users.id = posts.user_id;` as const
