// Integration Test: SELECT - multiple unnamed scalar expressions
// Integration Test: SELECT syntax validation
// Tests that multiple scalar expressions require AS aliases
...
// ❌ ERROR: scalar expressions need AS alias
