...
const query = `select public.lower(name) from t;` as const
...
type _errorCheck = Expect<
	Matches<ExtractQueryError<DbShape, typeof query>, DbtyperError<3617, "Qualified function names are not supported">>
>
