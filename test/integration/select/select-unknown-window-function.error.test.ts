// Integration Test: SELECT - unknown window function
...
const query = `select ghost_window_func() over (order by id) from users;` as const
...
type _errorCheck = Expect<
	Matches<ExtractQueryError<DbShape, typeof query>, DbtyperError<2402, "Unknown window function">>
>
