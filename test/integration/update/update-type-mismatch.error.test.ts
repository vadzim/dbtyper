...
const query = `update users set age = 'not a number' where id = '1' returning *;` as const
...
type _errorCheck = Expect<
	Matches<ExtractQueryError<DbShape, typeof query>, DbtyperError<2507, "Incompatible value type for column age">>
>
