// Integration Test: UPDATE - unknown schema or table
...
// ❌ ERROR: Unknown schema or table in UPDATE
const query = `update ghost_schema.users set name = 'test';` as const
...
type _errorCheck = Expect<
	Matches<
		...
		DbtyperError<2207, "Unknown schema or table ghost_schema in UPDATE">
	>
>
