...
type WrongStatementBeforeIncompletedStatementWithRecovering = SqlApplyStatements<
	SqlDatabase<"public">,
	ParseSqlStatementsRecovering<ParseSqlTokens<`create schema a; create schema a; select 1;`>>[1]
>
...
type WrongStatementBeforeIncompletedStatementStrict = SqlApplyStatements<
	SqlDatabase<"public">,
	ParseSqlStatements<ParseSqlTokens<`create schema a; create schema a; select 1;`>>[1]
>
